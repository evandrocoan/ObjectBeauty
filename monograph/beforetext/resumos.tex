...
\newcommand{\imprimirbrazilabstract}{%
    ...
    \begin{resumo}[Resumo]
        ...
        Enquanto a ferramenta de adição de cores já pode ser considerada completa (por que o processo de adição de cores em si é simples),
        a ferramenta de formatação de código~=fonte no futuro precisará ser completamente reescrita,
...
\newcommand{\imprimirenglishabstract}{%
    ...
    \begin{resumo}[Abstract]
        ...
        the source code formatting tool in the future will need to be completely rewritten,
