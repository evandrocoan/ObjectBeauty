...
\newcommand{\imprimirbrazilabstract}{%
    ...
    \begin{resumo}[Resumo]
        ...
        foi desenvolvido uma metagramática e
        ...
        é possível trabalhar com qualquer linguagem cuja a gramática foi especificada (seguindo das regras da metalinguagem desenvolvida neste trabalho).
