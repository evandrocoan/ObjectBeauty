...
foi criado uma nova gramática de gramáticas como mostrado na \typeref{MyWorflowForLarkTraduzido2}.
...
A final,
não é objecto deste trabalho fazer a análise completa de programas,
pela sua sintaxe e
semântica e
...
This idea to be empowered was initially developed by the text editor `Sublime Text' \cite{sublimeTextSyntax}.
