...
based on the use of deterministic \cite{TODO:
deterministic free grammars explanation} and controlled nondeterministic \cite{TODO:
section explaning what does controlled means} context free grammars.

This audacious goal,
can only be accomplished because the proposed tool does not rely on the lex,
syntax and semantic aspects \cite{TODO:
what does these languages aspects are} of any used languages.
Therefore,
...
as the objective of text formatters is to change the structural aspects \cite{TODO:
what are the source code formatters objectives}.



.sublime-syntax or my .object-beauty is a meta-language, as EBNF \cite{Extended Backus–Naur form}.
