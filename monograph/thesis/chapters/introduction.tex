...
\lang{%
    ...
    uma} barreira adicional \advisor{ao}{para cada um desses programadores
    no} desenvolvimento do projeto será aprender as diferenças de
...
extensível a qualquer linguagem de programação por meio de gramáticas.
