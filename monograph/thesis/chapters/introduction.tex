...
\lang{%
    ...
    torna\hyp{}se um desafio ter em um único projeto diversos programadores,
    ...
    \advisor{há uma dificuldade na leitura do código como algo homogêneo.
        ...
        B estão habituados.
    }{certas heurísticas tem sua taxa de acerto reduzida ao fazer o
    reconhecimento dos padrões.}Um exemplo de padrão que estaria prejudicado
...
\advisor{}{%
    \lang{%
        ...
        \begin{enumerate}
            \item Alguns programadores simplesmente fazem de um determinado jeito por
            que foi assim que eles aprenderam de seus tutores ou possuem
            determinado estilo devido as suas experiências iniciais e
            nunca preocuparam\hyp{}se em questionar se poderia ser feito de outra maneira.
            Um caso onde isso pode acontecer é devido ao cansaço que algumas linguagens
            de programação como \latex causam por sua sintaxe incomum e
            extraordinária.
...
\begin{citacao}
    ...
    \footnote{\englishword{I'd say there are two main reasons to enforce a single code format in a project.
...
\lang{%
    ...
    \advisor{
        Essas conclusões seguem porque ao trabalhar com um sistema de versionamento como ``git'',
        ...
        eles podem perder um tempo precioso que eles poderiam estar utilizando para escrever código.
        E no fim,
        o histórico git irá conter ruídos desnecessários,
        pois o foco de um sistema de versionamento é somente conter mudanças se sejam significativas,
...
\lang{%
    ...
    pois o desenvolvedor pode focar mais seus esforços pensando
...
\begin{enumerate}
    ...
    \lang{%
        ...
        \item Projetar uma ferramenta que permita \advisor{a}{} várias e
