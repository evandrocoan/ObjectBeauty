...
\lang{%
    ...
    to use a versioning control system \cite{whyVersionControlIsCritical} which enable project manager\s and
...
\advisor{}{%
    \lang{%
        ...
        night shift programmer had just removed them \cite{whoWroteThisCrap}?
    }{%
