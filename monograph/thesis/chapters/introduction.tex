...
\advisor{}{%
    \lang{%
        ...
        \begin{enumerate}
            ...
            que foi assim que eles aprenderam de seus tutores ou
...
\begin{citacao}
    ...
    duas \cite[tradução nossa]{Geukens}\footnote{\englishword{I'd say there are two main reasons to enforce a single code format in a project.
...
\advisor{}{%
    \lang{%
        ...
        só porque algum programador do turno da noite\footnote{\url{https://blog.codinghorror.com/who-wrote-this-crap/}} tinha acabado de removê-los?
    }
}
