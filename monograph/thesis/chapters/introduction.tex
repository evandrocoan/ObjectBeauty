...
\lang{%
    ...
    \begin{enumerate}
        ...
        \item
        Uma característica física que pode determinar
    \end{enumerate}
    Hoje em dia,
    com a criação de sistemas computacionais cada vez mais complexos,
    torna-se um problema juntar em um único projeto diversos programadores,
    cada um com suas características pessoais distintas.
