...
\chapter{\lang{Implementação}{Implementation}}\label{sec:implementation}
...
\begin{englishtext}
    ...
    proposals of this work, in the chapter: `8.1.2 \brazilword{Separação de
    formato de exibição e de saída}':
...
% Portuguese
\lang{}{\input{chapters/implementação}}
