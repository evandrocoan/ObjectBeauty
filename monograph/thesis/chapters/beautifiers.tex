...
Qualquer outra opção adicional inserida manualmente pelo usuário serão apagadas,
...
são todas as ferramentas de formação.
Ou elas serão configuradas,
diretamente pelo usuário editando arquivos de configuração \cite{uncrustifySourceCode},
...
formatadores de código~=fonte seguem o processo tradução como apresentado na \fullref{compiladoresEtradutores}.
Mas diferente do usual para um tradutor,
