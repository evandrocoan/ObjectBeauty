...
\lang{%
    ...
    utilizados para classificar trechos de código~=fonte como ``bem legíveis'' ou
    ``mal legíveis''.
    Inicialmente estes estudos começam coletando dados de pessoas,
    para então treinar Inteligências Artificiais para classificar códigos~=fonte.
...
\begin{citacao}
    ...
    Por mau exemplo.
    \cite[tradução nossa]{deathToTheSpaceInfidels}\footnote{
    \englishword{%
...
\begin{citacao}
    ...
    sem esfaquear os seus companheiros de equipe ao longo do caminho.
    \cite[tradução nossa]{deathToTheSpaceInfidels}\footnote{
    \englishword{%
    So yes,
