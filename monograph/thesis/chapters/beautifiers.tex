...
\lang{%
    A robust Code Beautifier can get a lot more complicated just with the basic definitions of formatting (\autoref{source_code_beautifiers}) applied over each language own characteristics as for example:
...
\lang{
    ...
    encontra~=se mais de 500 configurações tais como o \autoref{uncrustifySettingSample},
...
\lang{%
    ...
    Por exemplo,
    você consegue claramente entender o que a última regra do \autoref{uncrustifySettingSample} significa?
}
...
veja o \autoref{exemploDeOfuscador}.
...
Por exemplo,
diferente da linguagem \textit{JavaScript} utilizada no \autoref{exemploDeOfuscador},
