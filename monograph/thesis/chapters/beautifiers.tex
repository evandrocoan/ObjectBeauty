...
\lang{%
    ...
    Alguns estudos como \citeonline{improvingCodeReadability} implementam modelos de Inteligências Artificiais,
    utilizados para classificar códigos~=fonte como ``bem legíveis'' ou
    ``mal legíveis''.
    ...
    Além desses estudos científicos para classificar códigos~=fonte,
