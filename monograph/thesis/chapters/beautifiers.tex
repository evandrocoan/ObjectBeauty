...
\lang{%
    ...
    Somente indícios de que certas características combinadas podem melhorar ou
    facilitar a tarefa de programar \cite{pep8operatorsBlankLine}.
}%
\begin{citacao}
    ...
    Eles destroem os relacionamentos entre colegas,
...
\lang{%
    On \citeonline{improvingCodeReadability} was analyzed the level of program comprehension which can be gained by the indentation and
    was constated that the indentation levels of 2 and
