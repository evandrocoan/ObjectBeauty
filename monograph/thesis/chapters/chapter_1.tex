...
\chooselang
{
    ...
    empty line may call better your attention. % TODO, put reference for this
    ...
    them, or perhaps he forgot to insert them. % TODO, put reference for this
    ...
    each one of your beloved if\s, just because some night shift programmer had just removed them? % TODO, put reference for this
    ...
    \begin{enumerate}
        ...
        in-depth study on the good practices on visual layout area, also known as code
        `Beautifying'.
...
{ % Portuguese
    ...
    código colocando linhas novas antes de cada um dos if\s por que o programador do
