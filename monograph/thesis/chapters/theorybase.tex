...
\section{Gramáticas}
    ...
    Por isso,
    também podemos chamar uma dada Gramática Regular de Tipo 0 ou Livre de Contexto.
...
\label{analisadoresSintaticos}
    ...
    viabilizar a implementação de parsers Ascendentes Determinísticos.
    ...
    parser que reconhece as linguagens representadas por elas.
