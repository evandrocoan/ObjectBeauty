...
\subsection*{Gramáticas Sensíveis ao Contexto}
    ...
    \cite{turingMachinesRoyer} com Fita (ou memória) Finita.
...
\label{classesDeComplexidade}
    ...
    o caminho pulando'' ramos de Computação Não~=Determinísticos.
    \begin{figure}[H]
    \centering
    ...
    enquanto $P \stackrel{?}{=} NP$ ainda não é decido \cite{turingMachinesRoyer,computationalComplexityAuroraBarak}.
    ...
    \ref{fig:pictures/ParserDeterministic.png} e as compare.} de execução.
    ...
    Não~=Determinística,
    utiliza~=se uma Máquina de Turing Determinística \cite{turingMachinesRoyer}.
