...
\lang{%
    ...
    Tal sentença pode ser ou a declaração de um ponteiro chamado de \textit{y} do tipo \textit{x},
    ou a multiplicação de dois números armazenados nas variáveis \textit{x} e
    \textit{y}.
    Uma otimização que o compilador C faz para poder saber se a expressão
    trata~=se de de uma mera multiplicação ou a declaração de uma variável,
    ...
    Determinísticas,
    uma vez que a gramática não é mais Livre de Contexto ou determinística,
