...
\lang{%
    ...
    \caption{Linguagens Determinísticas -- Adaptação de \citeonline{beatty1982} e \citeonline{ahoCompilerDragonBook}}
    ...
    \citeonline{lalrDeRemer1982} criaram os parsers LALR(K)\footnote{\textit{Look-Ahead LR parser},
    i.e.,
