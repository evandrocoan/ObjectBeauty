...
\lang{%
    ...
    tem~=se um processo de tradução (\autoref{ProcessoTraducao.png}).
...
\end{quadro}
    ...
    reveja a \fullref{HierarquiaDeChomsky.png}.
...
\label{mecanismosReconhecedores}
    ...
    Na \autoref{ParserDeterministic.png},
