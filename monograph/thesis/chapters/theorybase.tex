...
\label{classesDeComplexidade}
    ...
    realizar a execução de todos os ramos Não~=determinísticos de Computação em tempo Linear ou
    Polinomial \cite{theGoodAndBadQuantumComputing}.
    ...
    somente otimizadores na resolução de alguns problemas específicos que podem ser otimizados devido as propriedades específicas\slash{}probabilísticas das leis Física Quântica \cite{churchTuringQuantumComputer}.
    }
    \begin{figure}[H]
    \centering
