...
\label{classesDeComplexidade}
    ...
    Em contra~=partida,
    Gramáticas Livre de Contexto Não~=Determinísticas também podem ser Analisadas em tempo Polinomial $\Theta(n^3)$ utilizando algoritmos de parsing tal como CYK (seção \ref{hierarquiaDeChomsky,larkContextualLexer}).
