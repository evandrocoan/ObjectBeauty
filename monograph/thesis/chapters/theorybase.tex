...
\label{classesDeComplexidade}
    ...
    Em contra~=partida,
    Gramáticas Livre de Contexto Não~=Determinísticas também podem ser analisadas em tempo polinomial $\Theta(n^3)$ utilizando algoritmos de parsing tal como CYK (\citeonline{larkContextualLexer} e
