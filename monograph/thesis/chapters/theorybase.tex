...
Irrestrita (\typeref{HierarquiaDeChomsky}).
\begin{figure}[h]
\centering
...
Sensíveis ao Contexto como apresentado na \typeref{HierarquiaDeChomsky}.
Por isso,
...
A \typeref{LinguagensDeterministicas} não é inteiramente um Diagrama de Venn \cite{generalizedVennDiagrams},
inicialmente,
...
LR(K).
Reveja os parágrafos após a \typeref{HierarquiaDeChomsky}
},
...
reveja a \typeref{HierarquiaDeChomsky} e
...
Na Figura \typeref{ParserNonDeterministic},
...
Como mostrado na Figura \typeref{ParserNonDeterministic},
...
Veja as Figuras \typeref{ParserNonDeterministic,ParserDeterministic} e
as compare.
...
Como já explicado nas observações da \typeref{HierarquiaDeChomsky},
...
A \typeref{ParserDeterministic} mostrou um exemplo de uso do algoritmo de Busca em Profundidade.
