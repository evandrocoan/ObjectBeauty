...
\titulo{\lang{A Reprogrammable Code Formatting Tool}{Uma Ferramenta de Formatação Reprogramável Por Gramáticas}}
...
\palavraschaveufsc{palavraschaveingles}   {source code}
\palavraschaveufsc{palavraschaveportugues}{código-fonte}

\palavraschaveufsc{palavraschaveingles}   {formatter}
\palavraschaveufsc{palavraschaveportugues}{formatador}

\palavraschaveufsc{palavraschaveingles}   {beautifier}
\palavraschaveufsc{palavraschaveportugues}{embelezante}

\palavraschaveufsc{palavraschaveingles}   {prettyprint}
\palavraschaveufsc{palavraschaveportugues}{prettyprint}

\palavraschaveufsc{palavraschaveingles}   {universal}
\palavraschaveufsc{palavraschaveportugues}{universal}

\palavraschaveufsc{palavraschaveingles}   {reuse}
\palavraschaveufsc{palavraschaveportugues}{reuso}

\palavraschaveufsc{palavraschaveingles}   {blocks}
\palavraschaveufsc{palavraschaveportugues}{blocos}

\palavraschaveufsc{palavraschaveingles}   {object}
\palavraschaveufsc{palavraschaveportugues}{objeto}

\palavraschaveufsc{palavraschaveingles}   {oriented}
\palavraschaveufsc{palavraschaveportugues}{orientado}

\palavraschaveufsc{palavraschaveingles}   {programming}
\palavraschaveufsc{palavraschaveportugues}{programação}

\palavraschaveufsc{palavraschaveingles}   {structured}
\palavraschaveufsc{palavraschaveportugues}{estruturada}

\palavraschaveufsc{palavraschaveingles}   {parsing}
\palavraschaveufsc{palavraschaveportugues}{análise}

\palavraschaveufsc{palavraschaveingles}   {parse}
\palavraschaveufsc{palavraschaveportugues}{analisador}

\palavraschaveufsc{palavraschaveingles}   {regular}
\palavraschaveufsc{palavraschaveportugues}{regular}

\palavraschaveufsc{palavraschaveingles}   {expression}
\palavraschaveufsc{palavraschaveportugues}{expressão}

\palavraschaveufsc{palavraschaveingles}   {regex}
\palavraschaveufsc{palavraschaveportugues}{regex}

\palavraschaveufsc{palavraschaveingles}   {C}
\palavraschaveufsc{palavraschaveportugues}{C}

\palavraschaveufsc{palavraschaveingles}   {C++}
\palavraschaveufsc{palavraschaveportugues}{C++}

\palavraschaveufsc{palavraschaveingles}   {grammar}
\palavraschaveufsc{palavraschaveportugues}{gramática}

\palavraschaveufsc{palavraschaveingles}   {Turing}
\palavraschaveufsc{palavraschaveportugues}{Turing}

\palavraschaveufsc{palavraschaveingles}   {machine}
\palavraschaveufsc{palavraschaveportugues}{máquina}

\palavraschaveufsc{palavraschaveingles}   {automata}
\palavraschaveufsc{palavraschaveportugues}{autômatos}

\palavraschaveufsc{palavraschaveingles}   {lexer}
\palavraschaveufsc{palavraschaveportugues}{lexer}

\palavraschaveufsc{palavraschaveingles}   {syntax}
\palavraschaveufsc{palavraschaveportugues}{sintaxe}

\palavraschaveufsc{palavraschaveingles}   {Sublime}
\palavraschaveufsc{palavraschaveportugues}{Sublime}

\palavraschaveufsc{palavraschaveingles}   {Java}
\palavraschaveufsc{palavraschaveportugues}{Java}

\palavraschaveufsc{palavraschaveingles}   {Rust}
\palavraschaveufsc{palavraschaveportugues}{Rust}

\palavraschaveufsc{palavraschaveingles}   {Shell}
\palavraschaveufsc{palavraschaveportugues}{Shell}

\palavraschaveufsc{palavraschaveingles}   {script}
\palavraschaveufsc{palavraschaveportugues}{roteiro}

\palavraschaveufsc{palavraschaveingles}   {obfuscators}
\palavraschaveufsc{palavraschaveportugues}{ofuscadores}

\palavraschaveufsc{palavraschaveingles}   {learning}
\palavraschaveufsc{palavraschaveportugues}{aprendizado}

\palavraschaveufsc{palavraschaveingles}   {syntec}
\palavraschaveufsc{palavraschaveportugues}{Syntec}

\palavraschaveufsc{palavraschaveingles}   {teamicide}
\palavraschaveufsc{palavraschaveportugues}{teamicide}

\palavraschaveufsc{palavraschaveingles}   {concensus}
\palavraschaveufsc{palavraschaveportugues}{consenso}

\palavraschaveufsc{palavraschaveingles}   {indentação}
\palavraschaveufsc{palavraschaveportugues}{indentation}

\palavraschaveufsc{palavraschaveingles}   {settings}
\palavraschaveufsc{palavraschaveportugues}{configurações}
