...
\autor{Evandro Coan}
\titulo{Source Code Formatting Tools}
...
\orientador{Rafael de Santiago, \lang{Phd.}{Dr.}}
...
\coordenador{Renato Cislaghi, \lang{Phd.}{Dr.}}

% FIXME: Local da sua defesa
\local{\brazilword{Florianópolis, Santa Catarina} -- Brazil}

% FIXME: Ano da sua defesa
\ano{2019}
\biblioteca{University Library}
...
\formacao{Bachelor of Science Degree in Computer Science}
\programa{Undergraduate Program in Computer Science}

% FIXME: Preencha com Departamento de XXXXXX, Centro de XXXXXX
\centro{INE - Department of Informatics and Statistics, CTC - Technological Center}
