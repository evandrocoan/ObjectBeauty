...
Neste capítulo pode~=se ver na integra o arquivo do formatador de código~=fonte (\typeref{codeHighlighterPy}) que faz uso da metagramática no \typeref{grammarsGrammarPushdown}.
...
Neste capítulo pode~=se ver na integra o arquivo do formatador de código~=fonte (\typeref{codeFormatterPy}) que faz uso da metagramática no \typeref{grammarsGrammarPushdown}.
