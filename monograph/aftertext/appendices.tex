...
Neste trabalho,
foram desenvolvidas duas ferramentas que utilizam a mesma metagramática.
A primeira ferramenta é o módulo de adição de cores e
a segunda ferramenta é propriamente o formatador de código~=fonte.
...
\begin{minted}[fontsize=\small,fontfamily=zi4,linenos=true,numberblanklines=true,breaklines=true]{text}
