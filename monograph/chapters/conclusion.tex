...
Então,
seguindo as referências de \citeonline{objectBeautifierFutureWorks},
será possível encontrar a especificação completa sobre última versão implementação de formatadores de código~=fonte com os requerimentos deste trabalho.
