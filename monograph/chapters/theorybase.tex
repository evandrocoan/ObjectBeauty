...
não a linguagem,
com algoritmos como CYK (veja a \fullref{classesDeComplexidade}).
Por fim,
...
i.e.,
$\Theta(n)$.
Aprenda mais sobre classes de complexidade com \citeonline{cormenIntroductionToAlgorithms,computationalComplexityAuroraBarak}.
}
...
implementado através de algum algoritmo com tempo polinomial como CYK (\fullref{classesDeComplexidade}).
...
\advisor{}{
    ...
    \advisor{}{Os algoritmos funcionamento desses algoritmos de busca podem ser encontrados em \citeonline{cormenIntroductionToAlgorithms}.}
    ...
    ter o ``azar'' de que o primeiro ramo de computações seja infinito e
    que nunca levarão a solução do problema.
    \begin{figure}[!htb]
...
provas formais.
Diferente do conteúdo do próximo,
