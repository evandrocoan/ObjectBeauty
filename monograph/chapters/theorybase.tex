...
a Árvore Sintática da \typeref{figure:ArvoresDosTokens2} possui como nó folha a palavra ``token com nome''.
...
Sensíveis ao Contexto como apresentado na \typeref{figure:FigureHierarquiaDeChomsky}.
Por isso,
...
gramáticas geram palavras de sua linguagem (\typeref{section:reducoesEderivacoes}).
...
\cite{simuladorDeAutomatosEMaquinasDeTuring}}.
...
Ou algoritmos de tempo polinomial como CYK (veja a \fullref{section:classesDeComplexidade}).
}
...
Determinísticas,
o que não é verdade,
veja a próxima \fullref{section:alteracoesNosAnalisadoresSintaticos}.
...
é que elas tem desempenho \textit{garantida} pela sua Classe de Complexidade (Veja a \fullref{section:classesDeComplexidade}).
