...
Entretanto,
a ferramenta proposta por \citeonline{universalIndentGUI},
...
configurações de estilo (``.sublime-color-scheme'') do editor \citeonline{sublimeTextSyntax}.
...
estilo utilizados por \citeonline{sublimeTextSyntax} por que dos três trabalhos:
\begin{inparaenum}[1)]
...
quanto por que cria arquivos de estilo para editores de texto.
