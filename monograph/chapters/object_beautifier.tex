...
\end{enumerate}%
\begin{code}
\caption[Simbolo Inicial da Metagramática ``ObjectBeauty'']{Simbolo Inicial da Metagramática ``\mintinline{text}|ObjectBeauty|''}
...
\begin{code}
\caption[Construtor de ``AbstractFormatter'']{Construtor de ``\mintinline{text}|AbstractFormatter|''}
