...
A visita dos nodos pela função ``transform(tree)'' acontece simplesmente chamado métodos que a classe ``TreeTransformer'' (Definido no \typeref{semanticAnalizerConstructor}) define e
...
eles também podem ser visitados diretamente a partir de algum nodo pai deles ou
