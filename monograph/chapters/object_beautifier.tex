...
\end{enumerate}%
\begin{code}
\caption[Simbolo Inicial da Metagramática ``ObjectBeauty'']{Simbolo Inicial da Metagramática ``\mintinline{text}|ObjectBeauty|'' (\typeref{chapter:codigoDaMetagramatica})}
