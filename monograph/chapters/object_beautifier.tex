...
O operador ``match'' utilizado no final do \typeref{exemploDeGramaticaPawn1} server para
\begin{lstlisting}[caption={Exemplo de Gramática Parte 1},label={exemploDeGramaticaPawn1},style=yaml_style]
...
\begin{lstlisting}[caption={Exemplo de Gramática Parte 2},label={exemploDeGramaticaPawn2},style=yaml_style]
parens: {
    match: \( {
...
\begin{lstlisting}[caption={Exemplo de Gramática Parte 3},label={exemploDeGramaticaPawn3},style=yaml_style]
numbers: {
    match: '(\d+)(\.\{2\})(\d+)' {
        captures: {
...
\begin{lstlisting}[caption={Exemplo de Gramática Parte 4},label={exemploDeGramaticaPawn4},style=yaml_style]
check_brackets: {
    match: \) {
