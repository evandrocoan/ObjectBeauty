...
Em trabalhos relacionados com esta implementação de metagramática (\fullref{secion:sourceCodeHighlighters}),
...
é mostrado na primeira linha o trecho de código~=fonte ``\mintinline{text}|function f1 () {|'' e
