...
class Backend(pushdown.Interpreter):
    ...
    def __init__(self, tree, program, settings):
        super().__init__()
        self.tree = tree
        self.program = AbstractFormatter( program, settings )
...
\begin{lstlisting}[caption={Construtor de ``AbstractFormatter''},label={construtorDeParsedProgram},style=mypython]
