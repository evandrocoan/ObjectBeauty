...
que irá retornar como resultado a Árvore Sintática (\fullref{compiladoresEtradutores}).
...
e retornar como resultado a Árvore Sintática Abstrata (\typeref{performanceDoFormator,section:AnalisadorSemantico}).
...
Continuamente chamar diversos algoritmos independentes acarreta uma perda de performance em comparação com os formatadores de código~=fonte apresentados no \fullref{source_code_beautifiers}.
