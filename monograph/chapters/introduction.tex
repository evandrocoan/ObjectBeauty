...
\lang{%
    ...
    sintáticos (veja o último exemplo da \fullref{introducaoGramaticas}).
...
todos eles foram alcançados como pode ser observado dos \typeref{fundamentacaoTeorica,source_code_beautifiers,software_implementation,chapter:conclusion}.
