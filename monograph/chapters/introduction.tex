...
\lang{%
    ...
    Uma dessas diferenças é a maneira no qual cada programador organiza a estrutura do código~=fonte de acordo com seu estilo de formatação \cite{transformationForDomainSpecificOptimisation}.
    Por exemplo,
    ...
    \advisor{%
    há uma dificuldade na leitura do código~=fonte como algo homogêneo.
...
\lang{%
    ...
    \advisor{
        ...
        recomenda\hyp{}se manter todo o código~=fonte sobre um único estilo,
...
\lang{%
    ...
    Com isso,
    espera\hyp{}se que o desenvolvimento de códigos~=fonte demande menos trabalho,
...
Por fim,
nos \typeref{software_implementation,chapter:conclusion},
