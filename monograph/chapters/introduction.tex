...
\lang{%
    ...
    like all big scientific questions -- how do you explain something like that -- It can be broken down into sub\hyp{}questions.
    ...
    Muitos projetos podem\advisor{}{
    sempre} ser escritos pela mesma pessoa durante toda a vida desse projeto mas,
    ...
    e entende melhor o código escrito de acordo com seu costume,
    ...
    uma} barreira adicional \advisor{ao}{para cada um desses programadores no} desenvolvimento do projeto será aprender as diferenças de trabalho que cada um desses desenvolvedores possuem entre si.
    ...
    \advisor{%
    há uma dificuldade na leitura do código como algo homogêneo.
...
\advisor{}{%
    \lang{%
        ...
        \begin{enumerate}
            \item Alguns programadores simplesmente fazem de um determinado jeito por que foi assim que eles aprenderam de seus tutores ou
            ...
            já que o mesmo vem a muitos anos habituado a realizar a escrita de seus códigos desta determinada forma,
...
\lang{%
    ...
    we need to worry about on how it will be saved in the file system on its `plain\hyp{}text' mode.
    ...
    tenham o controle das (e de suas) mudanças no código \cite{redesignOfGit}.
}
...
\lang{%
    ...
    Hence,
    if every programmer re\hyp{}writes the history making changes like inserting new lines before each if,
    ...
    \advisor{
        ...
        devido a problemas que podem ser gerados ao permitir que cada programador escreva como lhe bem entender.
        Por exemplo,
        gerando ruídos de formatação,
        dificultando a revisão do código~=fonte,
        uma vez que cada programador que agora precisa entender diferentes estilos de formatação aplicados em um único arquivo ou
        ...
        eles perdem um tempo precioso que eles poderiam utilizar para escrever código.
        E no fim,
        ...
        Segue\hyp{}se estas conclusões devido aos problemas gerados ao permitir que cada programador escreva como lhe agrada melhor.
...
\advisor{}{%
    \lang{%
        ...
        have to go through your code re\hyp{}adding new lines before each one of your beloved if\s,
        ...
        Por exemplo,
        imagine como seria se todo os dias você tivesse que passar pelo código re~=adicionando novas linhas antes de cada um dos seus amados if\s,
...
\lang{%
    ...
    Estas ferramentas também são conhecidos como ``\textit{Source Code Beautifiers}'' ou
...
Ter que aprender e
configurar muitas ferramentas de formatação de código~=fonte é um tarefa cansativa e
exaustante (\fullref{formatadores_de_codigo}).
Mais ainda,
escrever uma nova ferramenta de formatação de código~=fonte para cada nova linguagem de programação que surgir.
Mesmo que estes pontos não fossem problema,
cada ferramenta de formatação de código~=fonte possui diferentes níveis de profundidade e
detalhamento no qual elas se integram com a (ou as) linguagens de programação que elas suportam.
O que pode tornar frustrante migrar de uma linguagem de programação para outra,
pela perda de controle da ferramenta de código~=fonte.
...
\begin{enumerate}
    ...
    \lang{%
        ...
        \item Projetar uma ferramenta que permita\advisor{
        a}{} várias e
...
No \typeref{fundamentacaoTeorica} foi realizado pesquisas em artigos científicos,
livros e
...
No \typeref{source_code_beautifiers} foi escolhido explicar sobre um formatador de código configurável por arquivos de texto e
...
No \typeref{software_implementation} é proposto um novo formatador de código~=fonte configurável por arquivos de texto e
...
No \typeref{fundamentacaoTeorica} é realizado uma fundamentação teórica sobre os conceitos necessários para desenvolvimento de compiladores e
especificação de gramáticas.
No \typeref{source_code_beautifiers} é explicado sobre dois tipos distintos de formatadores de código~=fonte.
Um formatador de código configurável por arquivos de texto e
outro configurável por uma interface gráfica com o usuário.
Por fim,
no \typeref{software_implementation} é apresentado a proposta e
